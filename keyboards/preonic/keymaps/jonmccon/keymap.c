 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      | Ctrl | Alt  | GUI  |ORANGE|    Space    |GREEN |   /  | Left | Down | Right|
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  _______, KC_LCTL, KC_LALT, KC_LGUI, ORANGE,   KC_SPC,  KC_SPC,  GREEN,   KC_SLASH, KC_LEFT, KC_DOWN, KC_RGHT  \
),
// 
