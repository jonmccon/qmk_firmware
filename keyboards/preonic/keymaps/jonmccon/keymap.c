 ...
 * |   ~  |   !  |   @  |   #  |   $  |   %  |   ^  |   _  |   -  |   +  |  =   | Del  |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |   ~  |MS BT1|MS UP |MS BT2|   $  |   %  |   ^  |   &  |   *  |   (  |   )  | Del  |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |MS WUP| MS L |MS DN | MS R |MS WDN|  F5  |  F6  |   _  |   +  |   [  |   ]  |  |   |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |MS WL |  F7  |  F8  |  F9  |MS WR |  F11 |  F12 |ISO ~ |ISO | |   {  |   }  |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |SCRNALL|Brite-|Brite+|      |      |             |      | Next | Vol- | Vol+ | Play |
 * `-----------------------------------------------------------------------------------'
 */
[_ORANGE] = LAYOUT_preonic_grid( \
  KC_TILD, KC_EXLM, KC_AT, KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_UNDS, KC_MINS, KC_PPLS, KC_EQL, KC_DEL, \
  KC_TILD, KC_MS_BTN1, KC_MS_UP, KC_MS_BTN2, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______, \
  KC_MS_WH_UP,  KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT,   KC_MS_WH_DOWN,   KC_F5,   KC_F6,   KC_UNDS, KC_PLUS, KC_LBRC,  KC_RBRC, KC_PIPE, \
  KC_MS_WH_LEFT, KC_F7,   KC_F8,   KC_F9,   KC_MS_WH_RIGHT,  KC_F11,  KC_F12,S(KC_NUHS),S(KC_NUBS), KC_LCBR, KC_RCBR, _______, \
 ...
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |  F7  |  F8  |  F9  |  F10 |  F11 |  F12 | C_S_LCBR | C_S_RCBR | ISO # |ISO / |       |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      | Next | Vol- | Vol+ | Play |
 * `-----------------------------------------------------------------------------------'
 */
[_GREEN] = LAYOUT_preonic_grid( \
  ...
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  C_S_LCBR, C_S_RCBR, KC_NUHS, KC_NUBS, _______, \
